...
INSERT INTO board (`user_id`,`content`, `status`, `title`, `flg` ,`create_at`, `update_at`) values (1, "test content1", "Y", "test title1", 1, now(), now());
INSERT INTO board (`user_id`,`content`, `status`, `title`, `flg` ,`create_at`, `update_at`) values (2, "test content2", "Y", "test title2", 1, now(), now());
